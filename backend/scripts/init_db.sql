...
-- Feed engagement (mirrors scripts/migrations/006_feed_engagement.sql).
-- "Me too" = same-issue experience (feeds severity/dedup); "confirm" =
-- third-party nearby verification (weighted separately, never boosts severity).
