...
export function OfficerBatchPage() {
  return (
    <div>
      <h1 className="type-display-md !text-3xl">Batch control</h1>
...
export function OfficerEscalationsPage() {
  ...
  useEffect(() => {
    getQueue({ limit: 100 }).then(({ data }) => setRows(Array.isArray(data) ? data : [])).catch(() => setFailed(true));
  }, []);
  const hot = useMemo(
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <h1 className="type-display-md !text-3xl">Escalations</h1>
